...
export default function Page1() {
  return (
    <div className="p-5 space-y-4">
      ...
      <AnimatedGroup
        preset="blur-slide"
        className="grid grid-cols-1 md:grid-cols-2 gap-4 [&>*]:will-change-transform"
      >
      ...
      {items.map((it) => (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span
              className={`text-xs px-2 py-0.5 rounded text-white ${it.color}`}
            >
              {it.value}
            </span>
          </div>
...
function Resources() {
  const links = [
    {
      label: "District Disaster Management",
      href: "#",
      desc: "Local advisories, helplines, and evacuation info.",
    },
    {
      label: "Shelter/Relief Center Map",
      href: "#",
      desc: "Nearest safe shelters and relief distribution points.",
    },
    {
      label: "Safety Handbook (PDF)",
      href: "#",
      desc: "Step-by-step guidance for households and communities.",
    },
    {
      label: "IMD Weather & Radar",
      href: "#",
      desc: "Official radar loops and warnings.",
    },
    {
      label: "River Level & Flood Monitoring",
      href: "#",
      desc: "Upstream river gauges and flood status.",
    },
    {
      label: "State Emergency Ops (SEOC)",
      href: "#",
      desc: "State-level incident updates and contacts.",
    },
  ];
  return (
    <AnimatedCard title="Useful Resources">
      <ul className="text-sm text-muted-foreground space-y-3">
        {links.map((l) => (
          <li key={l.label}>
            <a
              className="inline-flex items-start gap-2 hover:text-foreground transition-colors"
              href={l.href}
            >
