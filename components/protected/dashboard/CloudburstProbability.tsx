...
export default function CloudburstProbability({
  ...
  const data = [{ name: "Cloudburst", value: percent, fill: percent > 70 ? "#ef4444" : percent > 40 ? "#f59e0b" : "#22c55e" }];
  return (
        ...
        <div className="relative h-full">
          <ResponsiveContainer width="100%" height="100%">
            <RadialBarChart innerRadius="70%" outerRadius="100%" data={data} startAngle={90} endAngle={-270}>
              <RadialBar minAngle={15} background clockWise dataKey="value" isAnimationActive animationDuration={800} />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">risk next 6–12h</div>
            </div>
          </div>
        </div>
      </CardContent>
