          ...
          >
            ...
            >
              <Card className="h-full flex justify-center overflow-hidden">
                <CardContent className="relative m-auto size-fit pt-6 items-center">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="relative z-10 mt-6 space-y-2 text-center">
                    ...
                    <p className="text-foreground">
                      Uses cutting-edge AI and machine learning to forecast
                      cloudburst probabilities with high accuracy
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="relative z-10 mt-14 space-y-2 text-center">
                    <h2 className="text-lg font-medium transition">
                      Integrated Sensors & Satellite Data
                    </h2>
                    <p className="text-foreground">
                      Combines ground-based IoT sensors and satellite imagery
                ...
                <CardContent className="grid pt-6 sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-foreground">
                        Recieve instant alerts when a cloud burst is detected
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-foreground">
                        ...
                        Tempore ducimus veritatis cum autem corporis sit
                      </p>
                    </div>
                  </div>
